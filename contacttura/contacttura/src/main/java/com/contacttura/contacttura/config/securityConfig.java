...
import com.contacttura.service.CustomUserDetailService;
...
public class securityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private CustomUserDetailService customUserDetailSerevice;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(customUserDetailSerevice).passwordEncoder(new BCryptPasswordEncoder());
	}
}
